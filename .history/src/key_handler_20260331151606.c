...
/*   Updated: 2026/03/31 15:16:06 by eteofilo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	key_right(t_data *data, double margin, double move_speed)
{

}

static void	key_left(t_data *data, double margin, double move_speed)
{
...
int	key_handler(int keycode, t_data *data)
{
	...
	if (keycode == KEY_RIGHT)
		key_right(data, margin, move_speed);
	if (keycode == KEY_LEFT)
	{

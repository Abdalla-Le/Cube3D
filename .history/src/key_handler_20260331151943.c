...
/*   Updated: 2026/03/31 15:19:43 by eteofilo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	key_right(t_data *data, double margin, double rot_speed)
{
	double	old_dir_x;
	double	old_plane_x;
...
static void	key_left(t_data *data, double margin, double rot_speed)
{
	double	old_dir_x;
	double	old_plane_x;
...
int	key_handler(int keycode, t_data *data)
{
	...
	if (keycode == KEY_RIGHT)
		key_right(data, margin, rot_speed);
	if (keycode == KEY_LEFT)
		key_left(data, margin, rot_speed);
	return (0);
}

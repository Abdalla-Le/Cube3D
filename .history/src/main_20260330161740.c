...
void load_textures(t_data *data)
{
    ...
    data->tex[0].img_ptr = mlx_xpm_file_to_image(data->mlx, "textures/north.xpm", &w, &h);
    data->tex[1].img_ptr = mlx_xpm_file_to_image(data->mlx, "textures/south.xpm", &w, &h);
    data->tex[2].img_ptr = mlx_xpm_file_to_image(data->mlx, "textures/west.xpm",  &w, &h);
    data->tex[3].img_ptr = mlx_xpm_file_to_image(data->mlx, "textures/east.xpm",  &w, &h);
    ...
    while (i < 4)
    {
        ...
        data->tex[i].addr = (int *)mlx_get_data_addr(data->tex[i].img_ptr,
                                &data->tex[i].bpp,
                                &data->tex[i].line_len,
                                &data->tex[i].endian);
        i++;

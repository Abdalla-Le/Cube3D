...
void load_textures(t_data *data)
{
    ...
    data->tex_test[1].img_ptr = mlx_xpm_file_to_image(data->mlx, "textures/test.xpm", &w, &h);
    data->tex_test[2].img_ptr = mlx_xpm_file_to_image(data->mlx, "textures/stone.xpm",  &w, &h);
    data->tex_test[3].img_ptr = mlx_xpm_file_to_image(data->mlx, "textures/testt.xpm",  &w, &h);

...
/*   Updated: 2026/03/31 17:08:21 by eteofilo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!map->no_path) printf("NO Missing\n");
    if (!map->so_path) printf("SO Missing\n");
    if (!map->we_path) printf("WE Missing\n");
    if (!map->ea_path) printf("EA Missing\n");
    if (map->floor_color == -1) printf("Floor Missing\n");
    if (map->ceil_color == -1) printf("Ceil Missing\n");

...
/*   Updated: 2026/03/31 13:42:19 by eteofilo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	raycasting_loop(t_data *data)
{
	...
	while (x < W_WIDTH)
	{
		...
		raycast.delta_dist[0] = fabs(1 / raycast.ray_dir[0]); //variação da distância do raio; TL,DR: Quanto custa para um raio atravessar um bloco;
		raycast.delta_dist[1] = fabs(1 / raycast.ray_dir[1]);

		// --- CALCULA STEP E raycast.side_dist ---

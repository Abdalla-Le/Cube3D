...
/*   Updated: 2026/03/31 14:20:58 by eteofilo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void paint_textures(t_img cur_tex, int x, t_raycast *raycast, t_data *data)
{
	double	wall_x;
...
t_img	*set_textures(int x, t_raycast *raycast, t_data *data)
{
	int tex_index;
	t_img cur_tex;
